 ...
 *     1 <= s.length <= 500
 *     s 只包含小写英文字母。
 * @title: LeetCode_1370_UpAndDownString
 * @Author 19040838
 * @Date: 2020.11.25 17:43
 */
public class LeetCode_1370_UpAndDownString {
    ...
    public static void main(String[] args) {
        String[] strings = {"aaaabbbbcccc", "rat", "leetcode", "ggggggg", "spo"};
        for (String s : strings) {
            System.out.println(sortString(s));
        }
    }

    public static String sortString_01(String s) {
        int n = s.length();
